...
class PokeritemSpider(Spider):
    ...
    def parse_item(self, response):
        ...
        item['head'] = response.xpath("//*[@id='fullBody2']/div/section/section/div/h2//text()").extract()
        str = response.xpath("//*[@id='fullBody2']/div/section/section/div//text()").extract()
        item['name'] = PokeritemSpider.list_name[PokeritemSpider.j]
        item['body'] = ''
        for i  in str:
            item['body']  =item['body'] + i
