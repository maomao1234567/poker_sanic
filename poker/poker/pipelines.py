...
class PokerPipeline(object):
    def process_item(self, item, spider):
        ...
        cur = conn.cursor()
        sql = "insert into poker_info(title, describe_title, describe_content, illustrate_title, illustrate_content, relevant_title, relevant_content, study_title, study_content) values (%s, %s, %s, %s, %s, %s, %s, %s, %s)"
        title = item['title']
        ...
        values = (title, describe_title, describe_content, illustrate_title, illustrate_content, relevant_title, relevant_content,study_title, study_content)
